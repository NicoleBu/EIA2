...
(function (xmasTreeShop2) {
    ...
    function handleChange(_event) {
        ...
        if (target.id == "bulbs1") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            ballPrice1 = xmasTreeShop2.xmasBulbs[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
        ...
        if (target.id == "bulbs2") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            ballPrice2 = xmasTreeShop2.xmasBulbs[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
        ...
        if (target.id == "candles1") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            candlePrice1 = xmasTreeShop2.xmasCandles[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
        ...
        if (target.id == "candles2") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            candlePrice2 = xmasTreeShop2.xmasCandles[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
        ...
        if (target.id == "ornaments1") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            ornamentPrice1 = xmasTreeShop2.xmasOrnaments[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
        ...
        if (target.id == "ornaments2") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            ornamentPrice2 = xmasTreeShop2.xmasOrnaments[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
        ...
        if (target.id == "Lametta1") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            lamettaPrice1 = xmasTreeShop2.lametta[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
        ...
        if (target.id == "Lametta2") {
            ...
            let value = target.value;
            let _price = parseInt(value.substr(0, 1));
            lamettaPrice2 = xmasTreeShop2.lametta[_price].price;
            let HTML;
            HTML = "";
            HTML += "<a>";
            HTML += " " + value.substr(1);
